...
void fill_param_desc(void) {
  ...
  gModuleData->paramDesc[eParam_slew0].type = eParamTypeFix; 
  ...
  gModuleData->paramDesc[eParam_slew1].type = eParamTypeFix; 
  ...
  gModuleData->paramDesc[eParam_slew2].type = eParamTypeFix; 
  ...
  gModuleData->paramDesc[eParam_slew3].type = eParamTypeFix; 
