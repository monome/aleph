...
static void fill_param_desc(void) {
  ...
  /* gModuleData->paramDesc[eParamSvfHz].type = eParamTypeFix; */
  ...
  gModuleData->paramDesc[eParamSvfRq].type = eParamTypeFix;
  ...
  gModuleData->paramDesc[eParamSvfLow].type = eParamTypeFix;
  ...
  gModuleData->paramDesc[eParamSvfHigh].type = eParamTypeFix;
  ...
  gModuleData->paramDesc[eParamSvfBand].type = eParamTypeFix;
  ...
  gModuleData->paramDesc[eParamSvfNotch].type = eParamTypeFix;
  ...
  gModuleData->paramDesc[eParamSvfPeak].type = eParamTypeFix;
  ...
  gModuleData->paramDesc[eParamNoiseAmp].type = eParamTypeFix;
  ...
  gModuleData->paramDesc[eParamInAmp0].type = eParamTypeFix;
  ...
  gModuleData->paramDesc[eParamInAmp1].type = eParamTypeFix;
  ...
  gModuleData->paramDesc[eParamInAmp2].type = eParamTypeFix;
  ...
  gModuleData->paramDesc[eParamInAmp3].type = eParamTypeFix;
