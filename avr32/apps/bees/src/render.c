...
/// render gathered outputs
void render_gathered(void) {
  //// TODO
}

//==================================================
//==== render presets page
void render_presets(void) {
  u8 y = 0;                       // which line
  s32 n, nCenter;         // which list entry
