...
// Function Pointers
//-----------------------------------------------------------------------------
typedef int (*fn_diskio_read)(uint32 sector, uint8 *buffer,
                              uint32 sector_count);
typedef int (*fn_diskio_write)(uint32 sector, uint8 *buffer,
                               uint32 sector_count);
...
int fatfs_sector_reader(struct fatfs *fs, uint32 Startcluster, uint32 offset,
                        uint8 *target);
...
uint32 fatfs_get_file_entry(struct fatfs *fs, uint32 Cluster, char *nametofind,
