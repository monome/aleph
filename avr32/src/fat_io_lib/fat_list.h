...
//-----------------------------------------------------------------
inline void fat_list_insert_after(struct fat_list *list, struct fat_node *node,
...
//-----------------------------------------------------------------
inline void fat_list_insert_before(struct fat_list *list, struct fat_node *node,
                                   struct fat_node *new_node);
inline void fat_list_insert_before(struct fat_list *list, struct fat_node *node,
                                   struct fat_node *new_node) {
    FAT_ASSERT(list);
...
inline void fat_list_insert_first(struct fat_list *list,
...
// fat_list_is_empty:
//-----------------------------------------------------------------
inline int fat_list_is_empty(struct fat_list *list);
inline int fat_list_is_empty(struct fat_list *list) {
    FAT_ASSERT(list);
...
// fat_list_pop_head:
//-----------------------------------------------------------------
inline struct fat_node *fat_list_pop_head(struct fat_list *list);
inline struct fat_node *fat_list_pop_head(struct fat_list *list) {
    struct fat_node *node;
    ...
    if (node) fat_list_remove(list, node);
