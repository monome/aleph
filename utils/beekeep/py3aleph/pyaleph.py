...
import tkinter
import math
print ("trying to import pyaleph")
...
class simpleapp_tk(tkinter.Tk):
    ...
    def initialize(self):
        ...
        button0 = tkinter.Button(self,text="button 0",
                                command=self.OnButton0Click)
        button0.grid(column=1,row=3)

        button1 = tkinter.Button(self,text="button 1",
                                command=self.OnButton1Click)
        button1.grid(column=2,row=3)

        button2 = tkinter.Button(self,text="button 2",
                                command=self.OnButton2Click)
        button2.grid(column=3,row=3)

        button3 = tkinter.Button(self,text="button 3",
                                command=self.OnButton3Click)
        button3.grid(column=4,row=3)

        self.buttonM = tkinter.Button(self,text="button M",
