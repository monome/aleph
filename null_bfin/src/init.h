...
// timer configuration
// timer0 period is clocks between parameter updates
// want about 1ms == 500Mhz 
// 0x80000 = 524288 cycles = 1.048576ms
#define TIMER0_PERIOD 0x80000
#define TIMER0_WIDTH 0x40000
