...
custom audio processing modules should include this directory and define their own processFrame routine. 

NOTES

on the ADSP-BF533 EZ-KIT development board, pins 5 and 6 of SW9 must be turned ON to connect RSCLK0 -> TSCLK0 and RFS0 -> TFS0. 
thus, theblackfin will use the bit and frame clocks from the codec for both receive and transmit.
