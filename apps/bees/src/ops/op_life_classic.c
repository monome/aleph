...
#include "op_life_classic.h"

//-------------------------------------------------
//----- static function declaration
static void op_life_classic_in_next(op_life_classic_t* life, const io_t v);
static void op_life_classic_in_xsize(op_life_classic_t* life, const io_t v);
static void op_life_classic_in_ysize(op_life_classic_t* life, const io_t v);
static void op_life_classic_in_x(op_life_classic_t* life, const io_t v);
...
static void op_life_classic_in_noise(op_life_classic_t* life, const io_t v);
static void op_life_classic_in_rules(op_life_classic_t* life, const io_t v);
static void op_life_classic_in_focus(op_life_classic_t* life, const io_t v);
...
// pickle / unpickle
static u8* op_life_classic_pickle(op_life_classic_t* op, u8* dst);
static const u8* op_life_classic_unpickle(op_life_classic_t* op, const u8* src);


//-------------------------------------------------
//----- static vars
static op_in_fn op_life_classic_in_fn[9] = {
  (op_in_fn)&op_life_classic_in_next,
  (op_in_fn)&op_life_classic_in_xsize,
  (op_in_fn)&op_life_classic_in_ysize,
  (op_in_fn)&op_life_classic_in_x,
  (op_in_fn)&op_life_classic_in_y,
  (op_in_fn)&op_life_classic_in_set,
  (op_in_fn)&op_life_classic_in_noise,
  (op_in_fn)&op_life_classic_in_rules,
  (op_in_fn)&op_life_classic_in_focus
};

static const char* op_life_classic_instring  = "NEXT\0   XSIZE\0  YSIZE\0  X\0      Y\0      SET\0    NOISE\0  RULES\0  FOCUS\0  ";
...
void op_life_classic_init(void* mem) {
  op_life_classic_t* life = (op_life_classic_t*)mem;

  //--- monome
  life->monome.handler = (monome_handler_t)&op_life_classic_handler;
  ...
  life->super.in_fn = op_life_classic_in_fn;
  life->super.pickle = (op_pickle_fn) (&op_life_classic_pickle);
  life->super.unpickle = (op_unpickle_fn) (&op_life_classic_unpickle);

  life->super.in_val = life->in_val;
  life->super.out = life->outs;
  life->super.opString = op_life_classic_opstring;
  life->super.inString = op_life_classic_instring;
  life->super.outString = op_life_classic_outstring;
  life->super.type = eOpLifeClassic;
...
// de-init
void op_life_classic_deinit(void* op) {
  // release focus
  net_monome_set_focus(&(((op_life_classic_t*)op)->monome), 0);
}

//-------------------------------------------------
//----- static function definitions
static void op_life_classic_in_focus(op_life_classic_t* op, const io_t v) {
  if((v) > 0) {
    op->focus = OP_ONE;
  } else {
    op->focus = 0;;
...
// ===== monome handler
static void op_life_classic_handler(op_monome_t* op_monome, u32 edata) {
  static u8 x, y, z;
...
// pickle / unpickle
u8* op_life_classic_pickle(op_life_classic_t* op, u8* dst) {
...
const u8* op_life_classic_unpickle(op_life_classic_t* op, const u8* src ) {
