...
#define BITS (8*WORD)
#define CELLS (256*1024/sizeof(cell))
...
any stringToSym(char* str);
any callLisp1 (char *fnNmae, any arg1);
...
// aleph-specific lisp commands
any doEtchaFill(any);
any doEtchaPixel(any);
